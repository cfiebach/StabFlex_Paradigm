...
scenario = "Flex_left_oddeven_training";
pcl_file = "Flex_left_oddeven_training.pcl";
...
is odd or even. When the number is even, please answer by pressing the button c with your left index finger.
When the number is odd, please answer by pressing the button x with your left middle finger.";

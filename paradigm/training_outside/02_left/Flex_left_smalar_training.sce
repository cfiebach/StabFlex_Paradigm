...
scenario = "Flex_left_smalar_training";
pcl_file = "Flex_left_smalar_training.pcl";
...
When the number is smaller than 5, please answer by pressing the button n with your right index finger.
When the number is larger than 5, please answer by pressing the button m with your right middle finger.";

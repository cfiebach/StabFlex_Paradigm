...
scenario = "Flex_right_Training2";
pcl_file = "Flex_right_Training2.pcl";
...
text {caption = "#"; font = "Arial"; font_size = $item_font_size; font_color = 170, 170, 170;}inputitem_oben; #in PCL: set_caption & set_font_color
...
# Ende
text {caption = "END %correct"; font = "Arial"; font_size = $item_font_size; font_color = 255, 255, 255;} ende_text1; #set in PCL auf tatsaechlich korrekten
...
## Instruktionen
text {caption = "
Now, a second block of training will follow with exact the same task as before. 

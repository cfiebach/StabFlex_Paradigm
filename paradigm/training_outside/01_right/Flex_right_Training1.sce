...
scenario = "Flex_right_Training1";
pcl_file = "Flex_right_Training1.pcl";
...
even.
Please press the buttons n and m as you trained
before:
right index finger = number is odd
right middle finger = numer is even.";
...
- In the event that the lower number is brighter,
  ...
  smaller or larger than 5. Answer with the left 
  hand as trained before, with the left middle
  finger indicating smaller than 5 and the left 
  index finger indicating larger than 5. 

...
scenario = "Flex_right_Training3";
pcl_file = "Flex_right_Training3.pcl";
...
# Ende
text {caption = "END %korrect"; font = "Arial"; font_size = $item_font_size; font_color = 255, 255, 255;} ende_text1; #set in PCL auf tatsaechlich korrekten
text {caption = "
...
## Instruktionen
text {caption = "
Nun folgt der letzte Trainingsdurchgang, in dem Sie kein direktes Feedback mehr über die Korrektkeit 

...
scenario = "Flex_ScannerTrain_right";
pcl_file = "Flex_ScannerTrain_right.pcl";
...
#Alles okay?
picture {
   text {caption = "Now, one more block of training will follow. \nYou won't get any feedback now. \n\nright middle finger = even \nright index finger = odd \n left index finger = larger than 5 \n left middle finger = smaller than 5 \n\n\n\nAre you ready? \nYES = right index finger \nNO = left index finger. ";  # kleiner gemacht und 1 Absatz weniger
